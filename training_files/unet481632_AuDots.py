...
X = h5py.File('/global/scratch/cgroschner/combined_data/Bal_MedFilt_cutimages_20190726.h5','r')['images'][:,:,:,:]
Y = h5py.File('/global/scratch/cgroschner/combined_data/Bal_unFilt_cutimages_20190423_maps.h5','r')['maps'][:,:,:,:]
X = X/X.max()
Y = Y/Y.max()
trainX = X[:129,:,:,:]
trainY = Y[:129,:,:,:]
...
save_weights = '/global/scratch/cgroschner/unet481632_AuDots_07.h5'
save_weights_final = '/global/scratch/cgroschner/unet481632_AuDots_07_final.h5'
save_predictions = '/global/scratch/cgroschner/unet481632_AuDots_07.npy'
